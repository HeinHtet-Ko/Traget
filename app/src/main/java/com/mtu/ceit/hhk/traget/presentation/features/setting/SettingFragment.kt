package com.mtu.ceit.hhk.traget.presentation.features.setting
...
import com.mtu.ceit.hhk.traget.presentation.features.MainActivity
...
class SettingFragment:Fragment(R.layout.fragment_settings) {
    ...
    private fun viewInit(){
        ...
        binding.frSettingBarrelLy.setOnClickListener {
           showActiveBarrelDialog()
        }
    ...
    private fun showDialog(listener:(Int)->(Unit)){
        val dialog = SettingDialog()
        if(!dialog.isAdded)
            dialog.show(parentFragmentManager,SettingDialog.TAG)

        dialog.valueListener = listener

    }

    private fun showRvdialog(){
    ...
    private fun showActiveBarrelDialog(){
        val listener = {updatedValue:Int ->
            vm.setActiveId(updatedValue)
        }
        showDialog(listener)
    }
